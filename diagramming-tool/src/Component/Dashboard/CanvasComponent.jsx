...
const CanvasComponent = () => {
    ...
    const handleSave = async (fileName, format, saveToDatabase) => {
        ...
        try {
            ...
            // Create a temporary canvas element for image conversion
            ...
            <div className="dashboard-container">
                ...
                <div className="main">
                    <div className="button-container">
                        ...
                        {selectedShape && (
                            <>
                                <input type="color" className="bcolor" value={currentBorderColor} onChange={handleBorderColorChange} title="border color" />
